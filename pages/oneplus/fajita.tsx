  ...
  return (
    <div>
      <head>
        ...
        ></script>
        <title>OnePlus(fajita) - Havoc-OS</title>
      </head>
              ...
              <div className=" m-5 grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div className="flex md:flex-row flex-col">
                  <div className="md:mt-28">
                    ...
                    <p className="text-center sm:text-left">fajita</p>
                  </div>
                  <img
                    src="https://raw.githubusercontent.com/Havoc-OS/Devices/thirteen/images/fajita.png"
                    alt="Image 1"
                    className="w-[150px] h-52 md:mt-5 md:ml-3 ml-2"
                  />
                </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-5">
              ...
              <div className="bg-[#b8cadd] text-center rounded-[100px] md:rounded-[50px]">
                <div className="mt-4 flex flex-col justify-center items-center">
                  ...
                  <Link
                    href={
                      "https://sourceforge.net/projects/havoc-os/files/fajita/Havoc-OS-v6.0-20230722-fajita-Official-GApps.zip/download"
                    }
                    className="bg-blue-500 hover:bg-blue-700 text-white  py-2 w-32 rounded-3xl items-center justify-center md:h-10 text-center flex flex-col md:mt-10 mt-5 md:flex-row space-x-5 mb-3"
                  >
                    Download
              ...
              <div className="bg-[#b8cadd] text-center rounded-[100px] md:rounded-[50px]">
                <div className="mt-4 flex flex-col justify-center items-center">
                  ...
                  <Link
                    href={
                      "https://sourceforge.net/projects/havoc-os/files/fajita/"
                    }
                    className="bg-blue-500 hover:bg-blue-700 text-white  py-2 w-32 rounded-3xl items-center justify-center md:h-10 text-center flex flex-col md:mt-10 mt-5 md:flex-row space-x-5 mb-3"
                  >
                    Download
